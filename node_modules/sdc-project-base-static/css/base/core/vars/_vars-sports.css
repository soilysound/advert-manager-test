:root {
  ...
  /* Custom z-index for site header */
  --site-header-z-index: 99992;

  /* Custom underline for site header subnav links */
  --site-header-sub-nav-underline-color-override: currentColor;

  /* For transfer center styling */
  ...
  --sports-branding-football-primary-gradient: linear-gradient(-192deg, #cd2529 0%, #be2022 48.5%, #b70709 49%, #a00000 100%);
  --sports-branding-football-color: #fff;
  --sports-branding-football-font: "Sky Football";

  --sports-branding-football-pl-primary: #030c7e;
  --sports-branding-football-pl-gradient: linear-gradient(-192deg, #1d238a 0%, #222677 48.5%, #090f68 49%, #0e1151 100%);
  --sports-branding-football-pl-color: #fff;
  --sports-branding-football-pl-font: "Sky Premier League";

  /* `--sports-branding-premier-league-` naming to be deprecated in favour of `--sports-branding-football-pl-` */
  --sports-branding-premier-league-primary: var(--sports-branding-football-pl-primary);
  --sports-branding-premier-league-gradient: var(--sports-branding-football-pl-gradient);
  --sports-branding-premier-league-color: var(--sports-branding-football-pl-color);
  --sports-branding-premier-league-font: var(--sports-branding-football-pl-font);

  --sports-branding-football-wsl-primary: #4A386F;
  --sports-branding-football-wsl-secondary: #1E1034;
  --sports-branding-football-wsl-primary-gradient: linear-gradient(var(--sports-branding-football-wsl-primary), var(--sports-branding-football-wsl-secondary));

  /* `--sports-branding-football-womens-super-league-` naming to be deprecated in favour of `--sports-branding-football-wsl-` */
  --sports-branding-football-womens-super-league-primary: var(--sports-branding-football-wsl-primary);
  --sports-branding-football-womens-super-league-secondary: var(--sports-branding-football-wsl-secondary);
  --sports-branding-football-womens-super-league-primary-gradient: var(--sports-branding-football-wsl-primary-gradient);
